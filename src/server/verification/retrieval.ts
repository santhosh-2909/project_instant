...
import { buildQuery, similarity, tokenise, publisherReliability } from '@/shared/textMatch';
import type { RetrievedEvidence, RetrievalOutcome, EvidenceStance } from '@/shared/types';
...
export type { RetrievedEvidence, RetrievalOutcome, EvidenceStance } from '@/shared/types';
export {
  buildQuery,
  extractEntities,
  isTrustedPublisher,
